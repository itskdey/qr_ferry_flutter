<p align="center">
  <img src="assets/readme/qrferry-hero.svg" alt="QRFerry — offline optical file transfer" width="100%" />
</p>

<p align="center">
  <img alt="Flutter" src="https://img.shields.io/badge/Flutter-Mobile-0D1117?style=for-the-badge&logo=flutter&logoColor=61DAFB" />
  <img alt="Dart" src="https://img.shields.io/badge/Dart-%3E%3D3.11-0D1117?style=for-the-badge&logo=dart&logoColor=61DAFB" />
  <img alt="Platforms" src="https://img.shields.io/badge/Android_%7C_iOS-0D1117?style=for-the-badge&logoColor=white" />
  <img alt="License" src="https://img.shields.io/badge/MIT-0D1117?style=for-the-badge&logoColor=D8FF72" />
</p>
...
The sender reads a local file, optionally compresses it, splits it into numbered binary chunks, and renders those chunks as a repeating stream of QR frames. The receiver watches that stream through its camera, collects valid frames in any order, reconstructs the bytes, verifies integrity, and saves the recovered file locally.

The sender's **display** and the receiver's **camera** are the transport channel.

> [!NOTE]
> QRFerry is currently an MVP for experiments, learning, demos, air-gapped workflows, and relatively small files. It is not intended to replace a high-speed network transfer protocol.
...
<p align="center">
  <img src="assets/readme/qrferry-preview.svg" alt="QRFerry transfer telemetry states" width="100%" />
</p>
...
<p align="center">
  <img src="assets/readme/qrferry-flow.svg" alt="QRFerry visible-light transfer pipeline" width="100%" />
</p>
...
That design gives QRFerry a few useful properties:

- frames can arrive **out of order**
- duplicate frames can be ignored safely
- the receiver can join a transfer **mid-stream**
- a temporary camera miss does not immediately kill the session
- the complete file is verified before export

---

## Why QRFerry?

Most file-transfer tools depend on at least one shared resource: a local network, internet connection, discovery service, account, pairing flow, cable, or backend.
...
| **Local-first** | No account, backend, API key, or cloud storage is required |
...
| **UI** | Shows live transfer state, progress, frame position, loop count, file metadata, and protocol details |
...
<p align="center">
  <img src="assets/readme/qrferry-protocol.svg" alt="QRFerry FQR1 frame anatomy" width="100%" />
</p>
...
When reporting transfer problems, useful details include sender/receiver device models, OS versions, file type and size, selected FPS, lighting conditions, approximate progress when the failure occurred, and whether lowering FPS changed the result.
...
<p align="center">
  <br />
  <strong>DISPLAY → QR FRAMES → CAMERA → VERIFIED FILE</strong>
  <br />
  <sub>Device-to-device optical file transfer, built with Flutter.</sub>
</p>
